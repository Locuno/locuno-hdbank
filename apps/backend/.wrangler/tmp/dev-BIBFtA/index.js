...
// .wrangler/tmp/bundle-gwbVL6/checked-fetch.js
...
// .wrangler/tmp/bundle-gwbVL6/strip-cf-connecting-ip-header.js
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/middleware/secure-headers/index.js
var HEADERS_MAP = {
...
var createConfig = /* @__PURE__ */ __name((env) => ({
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/helper/cookie/index.js
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/utils/buffer.js
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/validator/validator.js
...
// ../../node_modules/.pnpm/@hono+zod-validator@0.2.2_hono@3.12.12_zod@3.25.76/node_modules/@hono/zod-validator/dist/esm/index.js
...
var AccountSchema = external_exports.object({
  ...
  accountNumber: external_exports.string(),
  accountType: external_exports.enum(["CHECKING", "SAVINGS", "CREDIT"]),
  balance: external_exports.number(),
  currency: external_exports.string().default("USD"),
  status: external_exports.enum(["ACTIVE", "INACTIVE", "FROZEN"]),
  createdAt: external_exports.date(),
  updatedAt: external_exports.date()
});
var TransactionSchema = external_exports.object({
  id: external_exports.string().uuid(),
  fromAccountId: external_exports.string().uuid().optional(),
  toAccountId: external_exports.string().uuid().optional(),
  amount: external_exports.number().positive(),
  currency: external_exports.string().default("USD"),
  type: external_exports.enum(["DEPOSIT", "WITHDRAWAL", "TRANSFER", "PAYMENT"]),
  status: external_exports.enum(["PENDING", "COMPLETED", "FAILED", "CANCELLED"]),
  description: external_exports.string().optional(),
  reference: external_exports.string().optional(),
  createdAt: external_exports.date(),
  updatedAt: external_exports.date()
});
var ApiResponseSchema = external_exports.object({
...
var TransferRequestSchema = external_exports.object({
  fromAccountId: external_exports.string().uuid(),
  toAccountId: external_exports.string().uuid(),
  amount: external_exports.number().positive(),
  description: external_exports.string().optional(),
  reference: external_exports.string().optional()
});
...
var PaginatedResponseSchema = external_exports.object({
  data: external_exports.array(external_exports.any()),
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/utils/jwt/jwt.js
var jwt_exports = {};
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/utils/encode.js
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/utils/jwt/types.js
...
// ../../node_modules/.pnpm/hono@3.12.12/node_modules/hono/dist/middleware/jwt/index.js
...
auth.post("/register", zValidator("json", RegisterRequestSchema), async (c) => {
  ...
  try {
    ...
    const payload = {
      ...
      exp: Math.floor(Date.now() / 1e3) + (config.jwt.expiresIn === "24h" ? 86400 : 3600)
    };
    const token = await sign2(payload, config.jwt.secret);
    const refreshToken = crypto.randomUUID();
    const refreshTokenExpiry = new Date(Date.now() + 7 * 24 * 60 * 60 * 1e3).toISOString();
...
auth.post("/refresh", zValidator("json", RefreshTokenSchema), async (c) => {
  ...
  try {
    ...
    const newToken = await sign2(payload, config.jwt.secret);
...
users.put("/me", zValidator("json", UpdateProfileSchema), async (c) => {
  try {
    ...
    const userService = new UserService(c.env);
    const updates = {};
    if (rawUpdates.firstName !== void 0)
      updates.firstName = rawUpdates.firstName;
    if (rawUpdates.lastName !== void 0)
      updates.lastName = rawUpdates.lastName;
    if (rawUpdates.phoneNumber !== void 0)
      updates.phoneNumber = rawUpdates.phoneNumber;
...
health.get("/detailed", async (c) => {
  ...
  return c.json({
    ...
    checks,
    uptime: Date.now()
    // In a real worker, this would be more meaningful
  }, allHealthy ? 200 : 503);
});

// dist/durable-objects/UserProfileDO.js
var UserProfileSchema = external_exports.object({
  ...
  kycStatus: external_exports.enum(["pending", "verified", "rejected"]).default("pending"),
  accountStatus: external_exports.enum(["active", "suspended", "closed"]).default("active"),
  createdAt: external_exports.string(),
  updatedAt: external_exports.string(),
  lastLoginAt: external_exports.string().optional(),
  loginAttempts: external_exports.number().default(0),
  lockedUntil: external_exports.string().optional()
});
var AuthDataSchema = external_exports.object({
  userId: external_exports.string(),
  email: external_exports.string().email(),
  passwordHash: external_exports.string(),
  salt: external_exports.string(),
  refreshTokens: external_exports.array(external_exports.object({
    token: external_exports.string(),
    expiresAt: external_exports.string(),
    createdAt: external_exports.string()
  })).default([]),
  twoFactorEnabled: external_exports.boolean().default(false),
  twoFactorSecret: external_exports.string().optional(),
  recoveryTokens: external_exports.array(external_exports.string()).default([])
});
var UserProfileDO = class {
  state;
  env;
  ...
  async authenticateUser(email, password) {
    try {
      ...
      if (userProfile.lockedUntil && new Date(userProfile.lockedUntil) > /* @__PURE__ */ new Date()) {
      ...
      if (!isValidPassword) {
        ...
        if (updatedProfile2.loginAttempts >= 5) {
          updatedProfile2.lockedUntil = new Date(Date.now() + 15 * 60 * 1e3).toISOString();
        }
        await this.state.storage.put(`profile:${email}`, updatedProfile2);
        return { success: false, error: "Invalid credentials" };
      }
  ...
  async storeRefreshToken(email, token, expiresAt, invalidateOld) {
    try {
      ...
      let validTokens = authData.refreshTokens.filter((rt) => new Date(rt.expiresAt) > /* @__PURE__ */ new Date());
      if (invalidateOld) {
  ...
  async validateRefreshToken(email, token) {
    try {
      ...
      if (!authData)
        return false;
      const validToken = authData.refreshTokens.find((rt) => rt.token === token && new Date(rt.expiresAt) > /* @__PURE__ */ new Date());
      return !!validToken;
    } catch {
      return false;
    }
  ...
  async validateRefreshTokenByToken(token) {
    try {
      ...
      for (const [key, authData] of allKeys) {
        const data = authData;
        const validToken = data.refreshTokens.find((rt) => rt.token === token && new Date(rt.expiresAt) > /* @__PURE__ */ new Date());
        if (validToken) {
...
__name(UserProfileDO, "UserProfileDO");
...
// ../../node_modules/.pnpm/wrangler@3.114.14_@cloudflare+workers-types@4.20250924.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-gwbVL6/middleware-insertion-facade.js
...
// ../../node_modules/.pnpm/wrangler@3.114.14_@cloudflare+workers-types@4.20250924.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-gwbVL6/middleware-loader.entry.ts
